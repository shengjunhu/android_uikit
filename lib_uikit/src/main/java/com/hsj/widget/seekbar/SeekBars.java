...
public class SeekBars extends View {
    ...
    private ConfigBuilder mConfigBuilder; // config attributes
    ...
    public SeekBars(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SeekBars, defStyleAttr, 0);
        mMin = a.getFloat(R.styleable.SeekBars_sb_min, 0.0f);
        mMax = a.getFloat(R.styleable.SeekBars_sb_max, 100.0f);
        mProgress = a.getFloat(R.styleable.SeekBars_sb_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.SeekBars_sb_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.SeekBars_sb_track_size, SeekBarsUtils.dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.SeekBars_sb_second_track_size,
                mTrackSize + SeekBarsUtils.dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.SeekBars_sb_thumb_radius,
                mSecondTrackSize + SeekBarsUtils.dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.SeekBars_sb_thumb_radius_on_dragging,
                mSecondTrackSize * 2);
        mSectionCount = a.getInteger(R.styleable.SeekBars_sb_section_count, 10);
        mTrackColor = a.getColor(R.styleable.SeekBars_sb_track_color,
                ContextCompat.getColor(context, R.color.colorBlue));
        mSecondTrackColor = a.getColor(R.styleable.SeekBars_sb_second_track_color,
                ContextCompat.getColor(context, R.color.colorBlue));
        mThumbColor = a.getColor(R.styleable.SeekBars_sb_thumb_color, mSecondTrackColor);
        isShowSectionText = a.getBoolean(R.styleable.SeekBars_sb_show_section_text, false);
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.SeekBars_sb_section_text_size, SeekBarsUtils.sp2px(14));
        mSectionTextColor = a.getColor(R.styleable.SeekBars_sb_section_text_color, mTrackColor);
        isSeekStepSection = a.getBoolean(R.styleable.SeekBars_sb_seek_step_section, false);
        isSeekBySection = a.getBoolean(R.styleable.SeekBars_sb_seek_by_section, false);
        int pos = a.getInteger(R.styleable.SeekBars_sb_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.SeekBars_sb_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.SeekBars_sb_show_thumb_text, false);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.SeekBars_sb_thumb_text_size, SeekBarsUtils.sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.SeekBars_sb_thumb_text_color, mSecondTrackColor);
        mBubbleColor = a.getColor(R.styleable.SeekBars_sb_bar_color, mSecondTrackColor);
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.SeekBars_sb_bar_text_size, SeekBarsUtils.sp2px(14));
        mBubbleTextColor = a.getColor(R.styleable.SeekBars_sb_bar_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.SeekBars_sb_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.SeekBars_sb_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.SeekBars_sb_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.SeekBars_sb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.SeekBars_sb_touch_to_seek, false);
        isAlwaysShowBubble = a.getBoolean(R.styleable.SeekBars_sb_always_show_bar, false);
        duration = a.getInteger(R.styleable.SeekBars_sb_always_show_bar_delay, 0);
        mAlwaysShowBubbleDelay = Math.max(duration, 0);
        isHideBubble = a.getBoolean(R.styleable.SeekBars_sb_hide_bar, false);
        isRtl = a.getBoolean(R.styleable.SeekBars_sb_rtl, false);
        setEnabled(a.getBoolean(R.styleable.SeekBars_android_enabled, isEnabled()));
        a.recycle();
        ...
        mRectText = new Rect();
        mTextSpace = SeekBarsUtils.dp2px(2);
        ...
        // init BubbleView
        mBubbleView = new SeekView(context);
        ...
        if (SeekBarsUtils.isMIUI() || Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + SeekBarsUtils.dp2px(2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + SeekBarsUtils.dp2px(2);
        }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = SeekBarsUtils.dp2px(14); // default 14dp
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height += mTextSpace * 2;
        setMeasuredDimension(resolveSize(SeekBarsUtils.dp2px(180), widthMeasureSpec), height);
    ...
    private void locatePositionInWindow() {
        ...
        mBubbleCenterRawSolidY -= SeekBarsUtils.dp2px(24);
        if (SeekBarsUtils.isMIUI()) {
            mBubbleCenterRawSolidY -= SeekBarsUtils.dp2px(4);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            float r = (mThumbRadiusOnDragging - SeekBarsUtils.dp2px(2)) / 2f;
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (isAutoAdjustSectionMark) {
                    ...
                    if (isHideBubble) {
                        animate().setDuration(mAnimDuration)
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
                <= (mLeft + SeekBarsUtils.dp2px(8)) * (mLeft + SeekBarsUtils.dp2px(8));
    }
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(SeekBars.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(SeekBars.this, getProgress(),
                            getProgressFloat(), true);
                }
            }
    ...
    void config(ConfigBuilder builder) {
        mMin = builder.min;
        mMax = builder.max;
    ...
    public ConfigBuilder getConfigBuilder() {
        if (mConfigBuilder == null) {
            mConfigBuilder = new ConfigBuilder(this);
        }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(SeekBars seekBars, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(SeekBars seekBars, int progress, float progressFloat);

        void getProgressOnFinally(SeekBars seekBars, int progress, float progressFloat, boolean fromUser);
    }
    ...
    public static abstract class OnProgressChangedListenerAdapter implements OnProgressChangedListener {
        ...
        @Override
        public void onProgressChanged(SeekBars seekBars, int progress, float progressFloat, boolean fromUser) {
        }

        @Override
        public void getProgressOnActionUp(SeekBars seekBars, int progress, float progressFloat) {
        }

        @Override
        public void getProgressOnFinally(SeekBars seekBars, int progress, float progressFloat, boolean fromUser) {
        }
    }
     ...
     **************************************  custom bubble view  ***********************************
     **********************************************************************************************/
    private class SeekView extends View {
        ...
        SeekView(Context context) {
            this(context, null);
        }

        SeekView(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            mBubblePath.quadTo(x1 - SeekBarsUtils.dp2px(2), y1 - SeekBarsUtils.dp2px(2), x1, y1);
            mBubblePath.arcTo(mBubbleRectF, 150, 240);

            float x2 = (float) (getMeasuredWidth() / 2f + Math.sqrt(3) / 2f * mBubbleRadius);
            mBubblePath.quadTo(x2 + SeekBarsUtils.dp2px(2), y1 - SeekBarsUtils.dp2px(2), x0, y0);
            mBubblePath.close();
